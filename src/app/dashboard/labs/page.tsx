...
export default function Labs() {
  ...
  const LabForm = ({ title }: { title: string }) => (
  ...
  return (
    <div className="min-h-screen flex bg-teal-50">
      ...
      <div className="flex-1 p-4 md:p-8 mt-14 md:mt-0">
        ...
        {showForm && <LabForm title="New Lab Record" />}
        {editingId && <LabForm title="Edit Lab Record" />}
                ...
                <div key={l.id} className="p-4">
                  ...
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      {l.fee_paid < l.fee && (
                        <button onClick={() => { const a = prompt(`Payment for ${l.patient_name}:`); if (a) handlePayment(l, parseInt(a)); }} className="text-teal-600 text-xs font-medium">Pay</button>
                      )}
                      {l.status === "Pending" && (
                        <button onClick={() => updateStatus(l, "Delivered")} className="text-green-600 text-xs font-medium">Delivered</button>
                      )}
