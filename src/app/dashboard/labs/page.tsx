      ...
      <div className="flex-1 p-4 md:p-8 mt-14 md:mt-0">
        ...
        {showForm && (
          <div className="bg-white rounded-xl p-4 md:p-6 border border-teal-100 mb-6">
            <h3 className="text-sm font-semibold text-teal-800 mb-4">New Lab Record</h3>
              ...
              labs.map(l => (
                <div key={l.id} className="p-4">
                  <div className="flex justify-between items-start mb-1">
                    ...
                    <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${l.status === "Delivered" ? "bg-green-100 text-green-700" : l.status === "Pending" ? "bg-orange-100 text-orange-700" : "bg-red-100 text-red-700"}`}>
                      {l.status}
                    </span>
                  </div>
